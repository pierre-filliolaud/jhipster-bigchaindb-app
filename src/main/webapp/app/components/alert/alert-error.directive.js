(function() {
    ...
    function jhiAlertErrorController ($scope, AlertService, $rootScope) {
        ...
        var cleanHttpErrorListener = $rootScope.$on('bigchaindbjhipsterApp.httpError', function (event, httpResponse) {
            var i;
            ...
            case 400:
                var errorHeader = httpResponse.headers('X-bigchaindbjhipsterApp-error');
                var entityKey = httpResponse.headers('X-bigchaindbjhipsterApp-params');
                if (errorHeader) {
